...
**What about the JavaScript plugins?** While Bootstrap does provide optional JavaScript plugins, they are written in jQuery, which we are decidedly not using in this codebase. You are free to build your own equivelenet in vanilla JavaScript or as a React component, or introduce a new package (within reason).
